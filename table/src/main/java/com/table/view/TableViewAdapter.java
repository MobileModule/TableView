    ...
    public void onBindViewHolder(final TableViewHolder holder, int position) {
        ...
        if (isLockColumn) {
            ...
            if (mLockAdapter == null) {
                ...
                itemDecoration.setDrawable(new ColorDrawable(ContextCompat.getColor(mContext, R.color.border_color)));
                holder.mLockRecyclerView.addItemDecoration(itemDecoration);
        ...
        if (mUnLockAdapter == null) {
            ...
            DividerItemDecoration itemDecoration = new DividerItemDecoration(mContext
                    , DividerItemDecoration.VERTICAL);
            itemDecoration.setDrawable(new ColorDrawable(ContextCompat.getColor(mContext, R.color.border_color)));
            holder.mMainRecyclerView.addItemDecoration(itemDecoration);
